                        ...
                        @csrf
                            <div class="-m-2">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    ...
                                    <label><input type="radio" name="is_selling" value="1" class="mr-2" @if($shop->is_selling===1){ checked }@endif>販売中</label>
                                    <label><input type="radio" name="is_selling" value="0" class="mr-2" @if($shop->is_selling===0){ checked }@endif>停止中</label>
                                    </div>
                                </div>
