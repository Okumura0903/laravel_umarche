                        ...
                        @method('put')
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    ...
                                    <label><input type="radio" name="type" value="{{\Constant::PRODUCT_LIST['add']}}" class="mr-2" checked>追加</label>
                                    <label><input type="radio" name="type" value="{{\Constant::PRODUCT_LIST['reduce']}}" class="mr-2">削減</label>
