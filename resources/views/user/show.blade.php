        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="md:flex md:justfy-around">
                        <div class="md:w-1/2">
                        <div class="swiper">
                    ...
                    <div class="border-t border-gray-400 my-8">
                        ...
                        <div class="mb-4 text-center"><button data-micromodal-trigger="modal-1" href="javascript:;" type="button" class="text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">ショップの詳細を見る</button></div>
                    </div>
                </div>
            </div>
        </div>
